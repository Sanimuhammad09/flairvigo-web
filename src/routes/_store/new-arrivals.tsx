    ...
    <main className="flex-1 bg-brand-bg">
      ...
      <section className="relative w-full h-[70vh] min-h-[500px] flex items-end justify-center pb-16">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl">
          <h1 className="font-serif text-5xl md:text-7xl font-bold mb-4 tracking-tight">New Arrivals</h1>
          <p className="font-sans text-lg md:text-xl mb-8 max-w-2xl mx-auto opacity-90">
            The latest innovations in medical apparel. Fresh colors, new fits, same premium quality.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/new-arrivals" className="bg-white text-brand px-10 py-4 font-bold tracking-widest text-sm uppercase rounded-full hover:bg-gray-100 transition-colors">
              Shop Tops
            </Link>
            <Link to="/new-arrivals" className="bg-white text-brand px-10 py-4 font-bold tracking-widest text-sm uppercase rounded-full hover:bg-gray-100 transition-colors">
              Shop Pants
      ...
      <section className="bg-white py-16 px-6 overflow-hidden border-t border-b border-brand-border">
        ...
        <div className="flex space-x-6 overflow-x-auto no-scrollbar max-w-[1600px] mx-auto pb-4">
          <Link to="/new-arrivals" className="flex flex-col items-center min-w-[120px] group">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 bg-white mb-16">
        <div className="flex flex-col justify-center items-center text-center p-12 md:p-24 order-2 md:order-1">
          ...
          <Link className="inline-block bg-brand text-white font-bold py-4 px-12 rounded-full hover:bg-opacity-90 transition-opacity uppercase tracking-widest text-sm" to="/new-arrivals">
            Shop Joggers
          </Link>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {(() => {
              ...
              const apiProducts = newProducts && Array.isArray(newProducts) ? newProducts : [];
